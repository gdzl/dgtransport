var App = function () {
	...
	var handleSparkline = function () {
		...
		$(".sparklinepie").each(function() {
		  ...
		  return $(this).sparkline("html", {
			type: "pie",
			height: height,
			sliceColors: [Theme.colors.blue, Theme.colors.red, Theme.colors.green]
		  });
		});
		//Sparkline Line
	...
	var handleDashFlotCharts = function () {
		...
		function chart_revenue() {
			var likes = [[1, Math.random()*200], [2, Math.random()*200], [3, Math.random()*200], [4, Math.random()*200],[5,Math.random()*200],[6, Math.random()*200],[7, Math.random()*200],[8, Math.random()*200],[9, Math.random()*200],[10, Math.random()*200],[11, Math.random()*200],[12, Math.random()*200]];
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "/dgtransport/resources/css/themes/" + color + ".css");
